...
const Contact = () => {
    return (
        ...
        <section className="contact-form border max-w-lg mx-auto my-20 p-8 bg-blue-950 shadow-md rounded-md ">
            <h2 className="text-4xl font-bold mb-6 text-center" data-aos="fade-up">Contact</h2>
            <form>
                ...
                <button type="submit" className="w-full bg-blue-950 text-white py-2 rounded-md">Send Message</button>
            </form>
        </section>
