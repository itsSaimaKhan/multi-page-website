...
const HomeContent = () =>{
    ...
    return(
        <section className="hero h-screen flex items-center bg-cover bg-center" style={{ backgroundImage: "url('/back1.jpg')"}}>
            <div className="pl-0 md:pl-16 text-white text-center">
                ...
                <button className="mt-6 px-6 py-3 bg-blue-950 hover:bg-blue-700 rounded-md font-bold">Shop Now</button>
            </div>
        </section>
